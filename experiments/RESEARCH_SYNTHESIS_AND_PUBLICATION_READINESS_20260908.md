...
**Более новый единый обзор, 12 сентября:**
[все результаты и анализ для ICLR](../publication/iclr2027/RESULTS_AND_ANALYSIS.md),
[сравнение результатов других авторов](../publication/iclr2027/RELATED_WORK_RESULTS.md).
Этот файл сохранён как исторический анализ; статусы и планы ниже не live.

Дата анализа: 8 сентября 2026 года.

**Актуализация 10 сентября после аудитов:**
[Приоритеты, ограничения сильных результатов и исполнимая очередь](RESEARCH_PRIORITIES_20260910.md).
Таблицы ниже сохраняют историческую сводку; P4c2 valid199 и P5 repeats уже
досчитаны, их свежие итоги приведены по новой ссылке. Новая причинная проверка
разделяет K1/K4 и свежесть наблюдения; универсальный свежий requery не доказан.

**Обновление навигации 9 сентября:** исторический статус SSH и development
ниже относится к 8 сентября. Последующие valid199 результаты, live проверка
сервера и текущие приоритеты собраны в
[плане ближайших исследований](RESEARCH_PRIORITIES_20260909.md).
На 13:10-13:13 MSK references 367/597, P5 ещё не стартовал;
OSC medoid valid199 не подтвердил преимущество над max-value.
...
Уточнение [аудита 10 сентября](P3C_IMPLEMENTATION_AUDIT_20260910.md): эти семь
cells новые относительно P3c intervention cohort, но все встречались в
calibration локализатора на других init. Поэтому unseen-cell generalization
всей системы не проверена. Raw SR/пары подтверждены; post-retreat rollback
в P3c/P3d ни разу не сработал, но остаётся дефектом deployable fallback.
